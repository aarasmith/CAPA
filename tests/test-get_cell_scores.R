...
#x <- get_cell_scores(iso, years, start_end = c(1,12), weights, draw_adm1 = TRUE, draw_points = TRUE)
...
test_that("get_cell_scores", {
  ...
  case_list <- list(
    get_cell_scores(760, 2020, start_end = c(1,12), test_weights),
    get_cell_scores(760, 2019:2020, start_end = c(2,11), test_weights),
    get_cell_scores(c(760, 368), 2020, start_end = c(1,12), test_weights),
    get_cell_scores("USA", 2020, start_end = c(1,12), test_weights)
  )
