...
cell_stats_qu_index <- "CREATE UNIQUE INDEX covering_stats_qu ON public.cell_stats_qu USING btree (iso3n, year, quarter, capa_id_adm1, sid, cell_pop, lo_25, lo_50, lo_100, md_25, md_50, md_100, hi_25, hi_50, hi_100, int_25, int_50, int_100)"
cell_stats_bi_index <- "CREATE UNIQUE INDEX covering_stats_bi ON public.cell_stats_bi USING btree (iso3n, year, half, capa_id_adm1, sid, cell_pop, lo_25, lo_50, lo_100, md_25, md_50, md_100, hi_25, hi_50, hi_100, int_25, int_50, int_100)"
